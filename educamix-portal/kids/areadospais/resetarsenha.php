...
<div class="account-container">
	...
	<div class="content clearfix">
		<form action="#" method="post" id="resetarsenha">
			...
			<div class="login-fields">
				...
				Digite o email cadastrado para alterar sua senha.
			...
			<div class="login-actions">
                ...
                <input type="submit" class="button btn btn-success btn-large" value="Enviar" id="btn">
...
<script src="js/myjs/resetarsenha.js"></script>
