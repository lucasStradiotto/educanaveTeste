...
if($act == 'get'){
    ...
    if ($pesquisaCod) {
        ...
        $mundo_turmaA = 5;
        $icone_turmaA = "turma01";
        $nome_turmaB = "Turma B";
        $codTurmaB = $codProfessor . '_1';
        $mundo_turmaB = 5;
        $icone_turmaB = "turma02";

        $resultadoA = $conn->cadastrarTurma($nome_turmaA, $idProf, $codTurmaA, $mundo_turmaA, $icone_turmaA);
        $resultadoB = $conn->cadastrarTurma($nome_turmaB, $idProf, $codTurmaB, $mundo_turmaB, $icone_turmaB);
    ...
    foreach ($searchAluno as $key => $value) {
        ...
        $moveAlunoTurmaZero = $conn->removerAluno($idUsuario);
    }
